...
export type WheresTheBoneCommand = { type: "SELECT_WAKE_TIME" | "TAKE_BONE" | "PEEK_WAKE_TIME" | "WAIT" | "SELECT_PACKMATE" | "START_VOTE" | "VOTE_TO_SKIP_DISCUSSION" | "VOTE"; targetPlayerId?: string; hour?: number; approved?: boolean };
