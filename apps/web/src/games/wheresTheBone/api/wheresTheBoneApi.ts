...
export type WheresTheBoneCommand = { type: "SELECT_WAKE_TIME" | "TAKE_BONE" | "PEEK_WAKE_TIME" | "WAIT" | "SELECT_PACKMATE" | "START_VOTE" | "VOTE"; targetPlayerId?: string; targetPlayerIds?: string[]; hour?: number };
