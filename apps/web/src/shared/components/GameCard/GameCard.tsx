...
import { LIARS_NUMBER_ASSETS } from "@/games/liarsNumber/assets/liarsNumberAssetManifest";
  ...
  return (
    <article className={`${styles.card} theme-card`}>
      <div className={`${styles.art} ${artClass}`} aria-hidden="true">
        ...
        ) : game.id === "liars-number" ? (
          <img className={styles.artPhoto} src={LIARS_NUMBER_ASSETS.cardBack} alt="" />
        ) : (
